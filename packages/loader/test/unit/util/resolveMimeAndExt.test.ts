...
describe('resolveMimeAndExt', () => {
  test('should return mime and ext with valid JPG extension and without enforceFormat', () => {
  ...
  test('should return mime and ext with valid JPEG extension and without enforceFormat', () => {
    expect(
      resolveMimeAndExt({ resourcePath: 'some/path/image.jpeg' })
    ).toEqual([Mime.JPEG, 'jpeg']);
  });

  test('should return mime and ext with valid PNG extension and without enforceFormat', () => {
  ...
  test('should return mime and ext with valid GIF extension and without enforceFormat', () => {
  ...
  test('should return mime and ext with valid WEBP extension and without enforceFormat', () => {
    expect(
      resolveMimeAndExt({ resourcePath: 'some/path/image.webp' })
    ).toEqual([Mime.WEBP, Extension[Mime.WEBP]]);
  });

  test('should return mime and ext with valid SVG extension and without enforceFormat', () => {
  ...
  test('should return mime and ext with valid JPG extension and valid enforceFormat', () => {
    expect(
      resolveMimeAndExt({ resourcePath: 'some/path/image.jpg' }, Mime.PNG)
    ).toEqual([Mime.PNG, Extension[Mime.PNG]]);
  });

  test('should return mime and ext with invalid extension and without enforceFormat', () => {
    expect(() =>
      resolveMimeAndExt({ resourcePath: 'some/path/image.xyz' })
    ).toThrow(new Error('Extension "xyz" is not supported.'));
  });

  test('should return mime and ext with invalid JPG extension and without enforceFormat', () => {
    expect(() =>
